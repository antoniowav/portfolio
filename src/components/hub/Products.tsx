...
function ProductRow({
  ...
  const rowClass =
    'group grid grid-cols-12 items-center gap-x-4 border-t border-line-strong py-6 transition-colors duration-300 hover:bg-paper-sink sm:py-9'
  ...
  const inner = (
    <>
      ...
      <div className="col-span-10 sm:col-span-7">
        <h3 className="text-[clamp(2rem,7vw,4.5rem)] font-bold leading-[0.95] tracking-[-0.03em] transition-transform duration-300 ease-expo group-hover:translate-x-2">
          {p.name}
        </h3>
